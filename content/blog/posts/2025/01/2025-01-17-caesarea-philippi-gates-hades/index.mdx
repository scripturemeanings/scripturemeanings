...
keywords: ["Caesarea Philippi", "gates of hell", "Peter's confession", "rock of the church", "Matthew 16", "Pan's grotto"]
tags: ["Caesarea Philippi", "gates of hell", "Peter", "church", "spiritual warfare", "New Testament"]
heroImage: "/images/caesarea-philippi-gates-hades.webp"
heroAlt: Ancient cave entrance at Caesarea Philippi, the Gates of Hades, with Mount Hermon in the background where Jesus proclaimed victory over death
---
...
<table className="w-full border-collapse my-6">
  <thead>
    <tr className="border-b-2 border-gray-300">
      <th className="text-left p-3 font-semibold">False gods</th>
      <th className="text-left p-3 font-semibold">True God</th>
    </tr>
  </thead>
  <tbody>
    <tr className="border-b border-gray-200">
      <td className="p-3">Pan (half-goat myth)</td>
      <td className="p-3">Jesus (fully God, fully human)</td>
    </tr>
    <tr className="border-b border-gray-200">
      <td className="p-3">Caesar (dead emperor)</td>
      <td className="p-3">Christ (living Lord)</td>
    </tr>
    <tr className="border-b border-gray-200">
      <td className="p-3">Gates of Hades (death)</td>
      <td className="p-3">Jesus (life eternal)</td>
    </tr>
    <tr className="border-b border-gray-200">
      <td className="p-3">Cave (darkness)</td>
      <td className="p-3">Light of the World</td>
    </tr>
    <tr className="border-b border-gray-200">
      <td className="p-3">Spring from unknown depths</td>
      <td className="p-3">Source of living water</td>
    </tr>
  </tbody>
</table>
